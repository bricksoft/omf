(function ($){
    var opts = {
        ...
        theme: 'default',
        yandexKey: false,
        tos_warn: 'By clicking "I Agree", you accept our terms, not only the summary above:',
        agree_btn: 'I Agree',
        cancel_btn: 'Cancel'
    };
    var themes = {
        default:function(settings){
            ...
            this.modal = $('<div class="jq-'+settings.prefix+' '+settings.prefix+'-wrapper out">'+
                            '<div class="jq-'+settings.prefix+' '+settings.prefix+'-modal">'+
                                ...
                                '<div class="'+settings.prefix+'-note"><small>'+opts.tos_warn+' <a href="'+settings.full+'">'+settings.full+'</a>.</small></div>'+
            ...
            this.agreeBtn = $('<button class="'+settings.prefix+'-button highlight">'+opts.agree_btn+'</button>');
            this.rejectBtn = $('<button class="'+settings.prefix+'-button">'+opts.cancel_btn+'</button>');
